  ...
  return (
    <section className="relative bg-[#1E0801] text-white py-12 text-center px-4 overflow-hidden">
      ...
      <main className="relative z-10 container mx-auto space-y-8">
        ...
        <div>
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 w-full md:w-[60%] mx-auto mb-2 border border-brand rounded-lg p-2">
            <input
            ...
            <button className="bg-brand px-6 py-3 rounded-md w-full text-sm md:text-l sm:w-auto cursor-pointer whitespace-nowrap">
              Join Waitlist
            </button>
          </div>
